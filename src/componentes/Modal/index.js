...
export default ({ showModal, name, image, types, moves, weight, height, background, pageX, pageY}) => {
    ...
    return (
            <div className="modal-container" id="container" onClick={handleCloseModal}>
                <div className="modal" style={{background:background, marginTop: `${pageX -200}px`}}>
